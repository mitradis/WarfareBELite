Понадобится игра стандартной версии 1.62 (обычный официальный патч для retail версии), игра на бета патче не рекомендуется. Запускать на выделенном сервере (arma2oaserver.exe).
