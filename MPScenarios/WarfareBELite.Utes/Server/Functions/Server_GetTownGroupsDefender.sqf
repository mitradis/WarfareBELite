...
switch (true) do {
	case (_sv < 20 || _maxsvdef == 0): {
		_units = [["Team", 2, 0],["Team_MG", 1, 0],["Team_AT", 1, 0],["Motorized", 1, 1],["Mechanized", 1, 1]];
		_percentage_inf = 75;
		_groups_max = 3;
	};
	case (_sv >= 20 && _sv < 40): {
		_units = [["Squad", 2, 0],["Team_MG", 2, 0],["Team_AT", 2, 0],["Team_Sniper", 1, 0],["Motorized", 2, 1],["Mechanized", 2, 1],["Armored_Light", 1, 1]];
		_percentage_inf = 70;
		_groups_max = 4;
	};
	case ((_sv >= 40 && _sv < 60) || _maxsvdef == 1): {
		_units = [["Squad_Advanced", 2, 0],["Team_AT", 2, 0],["Team_Sniper", 2, 0],["Team_AA", 1, 0],["Team_HAT", 1, 0],["Motorized", 2, 1],["Mechanized", 2, 1],["Armored_Light", 2, 1],["Mechanized_Heavy", 1, 1],["AA_Light", 1, 1]];
		_percentage_inf = 65;
		_groups_max = 5;
	};
	case (_sv >= 60 && _sv < 80): {
		_units = [["Squad_Advanced", 2, 0],["Team_AT", 2, 0],["Team_Sniper", 2, 0],["Team_AA", 2, 0],["Team_HAT", 2, 0],["Armored_Light", 2, 1],["Mechanized_Heavy", 2, 1],["AA_Light", 2, 1],["Armored_Heavy", 1, 1],["AA_Heavy", 1, 1]];
		_percentage_inf = 60;
		_groups_max = 6;
	};
	case (_sv >= 80 && _sv < 100): {
		_units = [["Squad_Advanced", 2, 0],["Team_AT", 2, 0],["Team_Sniper", 2, 0],["Team_AA", 2, 0],["Team_HAT", 2, 0],["Armored_Light", 2, 1],["Mechanized_Heavy", 2, 1],["AA_Light", 2, 1],["Armored_Heavy", 2, 1],["AA_Heavy", 2, 1]];
		_percentage_inf = 55;
		_groups_max = 7;
	};
	case (_sv >= 100): {
