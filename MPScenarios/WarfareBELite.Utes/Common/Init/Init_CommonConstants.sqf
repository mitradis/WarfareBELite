...
['WFBE_SIDESTARTINGDISTANCE',1500,false] Call SetNamespace;
//--- Starting Locations Mode: 0 = WN|ES; 1 = WS|EN; 2 = Random;
['WFBE_STARTINGLOCATIONMODE',1,false] Call SetNamespace;
...
['WFBE_TOWNBUILDPROTECTIONRANGE',250,false] Call SetNamespace;
...
['WFBE_TOWNMAXSVDEFENDER',0,true] Call SetNamespace;
