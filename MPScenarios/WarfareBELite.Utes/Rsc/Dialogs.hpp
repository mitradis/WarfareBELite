...
class WFBE_BuyGearMenu {
	...
	class controlsBackground {
		...
		class CA_Label_View : RscText {
			...
			y = 0.195;
			w = 0.20;
			text = $STR_WF_GEAR_MenuView;
			sizeEx = 0.035;
		};
		class CA_Label_Target : CA_Label_View {
			y = 0.15;
			text = $STR_WF_GEAR_MenuTarget;
		};
	};
	...
	class controls {
		...
		class CA_MakeTemplate : CA_Purchase {
			...
			text = $STR_WF_GEAR_MenuCreateTemplate;
			action = "WFBE_MenuAction = 601";
		};
		class CA_DeleteTemplate : CA_MakeTemplate {
			idc = 503010;
			x = 0.255;
			text = $STR_WF_GEAR_MenuDeleteTemplate;
