...
_i = _i + [['','',130,4,-1,0,0,0.86,'West',[]]];

_c = _c + ['US_Soldier_EP1'];
_i = _i + [['','',150,4,-1,0,0,0.86,'West',[]]];

_c = _c + ['US_Soldier_B_EP1'];
_i = _i + [['','',155,4,-1,0,0,0.86,'West',[]]];

_c = _c + ['US_Soldier_LAT_EP1'];
_i = _i + [['','',225,5,-1,0,0,0.88,'West',[]]];

_c = _c + ['US_Soldier_AT_EP1'];
_i = _i + [['','',350,5,-1,2,0,0.9,'West',[]]];

_c = _c + ['US_Soldier_HAT_EP1'];
_i = _i + [['','',800,6,-1,3,0,0.92,'West',[]]];

_c = _c + ['US_Soldier_AA_EP1'];
_i = _i + [['','',400,6,-1,2,0,0.91,'West',[]]];

_c = _c + ['US_Soldier_AR_EP1'];
_i = _i + [['','',210,5,-1,1,0,0.88,'West',[]]];

_c = _c + ['US_Soldier_MG_EP1'];
_i = _i + [['','',220,5,-1,0,0,0.89,'West',[]]];

_c = _c + ['US_Soldier_GL_EP1'];
_i = _i + [['','',160,5,-1,0,0,0.87,'West',[]]];

_c = _c + ['US_Soldier_Sniper_EP1'];
_i = _i + [['','',320,6,-1,2,0,0.92,'West',[]]];

_c = _c + ['US_Soldier_SniperH_EP1'];
_i = _i + [['','',350,6,-1,3,0,0.93,'West',[]]];

_c = _c + ['US_Soldier_Sniper_NV_EP1'];
_i = _i + [['','',370,6,-1,3,0,0.94,'West',[]]];

_c = _c + ['US_Soldier_Marksman_EP1'];
_i = _i + [['','',330,6,-1,2,0,0.91,'West',[]]];

_c = _c + ['US_Soldier_Medic_EP1'];
_i = _i + [['','',190,4,-1,0,0,0.89,'West',[]]];

_c = _c + ['US_Soldier_Engineer_EP1'];
_i = _i + [['','',225,5,-1,0,0,0.87,'West',[]]];

_c = _c + ['US_Soldier_AMG_EP1'];
_i = _i + [['','',185,6,-1,2,0,0.87,'West',[]]];

_c = _c + ['US_Soldier_AAR_EP1'];
_i = _i + [['','',185,6,-1,3,0,0.87,'West',[]]];

_c = _c + ['US_Soldier_AHAT_EP1'];
_i = _i + [['','',185,6,-1,3,0,0.89,'West',[]]];

_c = _c + ['US_Soldier_AAT_EP1'];
_i = _i + [['','',320,6,-1,3,0,0.88,'West',[]]];

_c = _c + ['US_Soldier_Spotter_EP1'];
_i = _i + [['','',320,6,-1,3,0,0.91,'West',[]]];

_c = _c + ['US_Soldier_Crew_EP1'];
_i = _i + [['','',120,4,-1,0,0,0.86,'West',[]]];

_c = _c + ['US_Soldier_Pilot_EP1'];
_i = _i + [['','',120,4,-1,0,0,0.87,'West',[]]];

_c = _c + ['US_Soldier_TL_EP1'];
_i = _i + [['','',240,5,-1,1,0,0.94,'West',[]]];

_c = _c + ['US_Soldier_SL_EP1'];
_i = _i + [['','',220,5,-1,2,0,0.93,'West',[]]];

_c = _c + ['US_Soldier_Officer_EP1'];
_i = _i + [['','',250,5,-1,1,0,0.92,'West',[]]];
...
_i = _i + [['','',1650,25,[false,true,2,0],0,2,0,'West',[]]];

_c = _c + ['M1126_ICV_mk19_EP1'];
_i = _i + [['','',1950,25,[false,true,2,0],0,2,0,'West',[]]];

_c = _c + ['M1129_MC_EP1'];
_i = _i + [['','',2300,25,-2,1,2,0,'West',[]]];

_c = _c + ['M1135_ATGMV_EP1'];
_i = _i + [['','',1850,25,-2,2,2,0,'West',[]]];

_c = _c + ['M1128_MGS_EP1'];
_i = _i + [['','',2450,25,-2,2,2,0,'West',[]]];

_c = _c + ['M1133_MEV_EP1'];
_i = _i + [['','',1950,25,-2,1,2,0,'West',[]]];

_c = _c + ['M2A2_EP1'];
_i = _i + [['','',4450,30,-2,1,2,0,'West',[]]];

_c = _c + ['M2A3_EP1'];
_i = _i + [['','',4950,32,-2,2,2,0,'West',[]]];

_c = _c + ['M1A1_US_DES_EP1'];
_i = _i + [['','',5650,40,-2,3,2,0,'West',[]]];
...
_c = _c + ['M6_EP1'];
_i = _i + [['','',8200,35,-2,3,2,0,'West',[]]];

/* Air Vehicles */
_c = _c + ['MH6J_EP1'];
_i = _i + [['','',12500,35,-2,0,3,0,'West',[]]];

_c = _c + ['UH60M_EP1'];
_i = _i + [['','',15000,35,-2,0,3,0,'West',[]]];

_c = _c + ['UH60M_MEV_EP1'];
_i = _i + [['','',18000,35,-2,0,3,0,'West',[]]];

_c = _c + ['CH_47F_EP1'];
_i = _i + [['','',20000,40,-2,0,3,0,'West',[]]];

_c = _c + ['C130J_US_EP1'];
_i = _i + [['','',26500,55,-2,1,3,0,'West',[]]];

_c = _c + ['AH6X_EP1'];
_i = _i + [['','',35000,50,-2,1,3,0,'West',[]]];

_c = _c + ['AH6J_EP1'];
_i = _i + [['','',30000,50,-2,1,3,0,'West',[]]];

_c = _c + ['AH64D_EP1'];
_i = _i + [['','',80000,60,-2,2,3,0,'West',[]]];

_c = _c + ['A10_US_EP1'];
_i = _i + [['','',100000,65,-2,3,3,0,'West',[]]];
...
_i = _i + [['','',15,0,0,0,'Fortification',0,'West',[]]];

_c = _c + ['US_WarfareBBarrier10x_EP1'];
_i = _i + [['','',25,0,0,0,'Fortification',0,'West',[]]];

_c = _c + ['US_WarfareBBarrier10xTall_EP1'];
_i = _i + [['','',50,0,0,0,'Fortification',0,'West',[]]];
