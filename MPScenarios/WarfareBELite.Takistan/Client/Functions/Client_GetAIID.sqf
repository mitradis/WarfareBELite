...
if (_unit == leader (group _unit)) exitWith {localize "STR_WF_PARAMETER_Leader"};
if (isPlayer _unit && _unit != leader (group _unit)) exitWith {localize "STR_WF_PARAMETER_Player"};
